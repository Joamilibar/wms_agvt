...
import { HiOutlineHome, HiOutlineCube, HiOutlineClipboardList, HiOutlineTruck, HiOutlineCog, HiOutlineLogout, HiOutlineMenu, HiOutlineX, HiOutlineBeaker, HiOutlineUsers, HiOutlineCollection, HiOutlineChartBar, HiOutlineScissors } from 'react-icons/hi';
...
const navItems: { to: string; icon: typeof HiOutlineHome; label: string; roles?: Role[] }[] = [
  ...
  { to: '/cotizador',   icon: HiOutlineScissors,      label: 'Cotizador sabanería' },
